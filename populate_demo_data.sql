...
BEGIN
  ...
  -- 5. Inserir Fluxos (inicialmente com flow_data vazio para evitar problemas no INSERT)
  ...
  -- 9. Atualizar flow_data dos fluxos com a estrutura visual do Builder (rodando após as perguntas estarem criadas)
  UPDATE fluxo SET flow_data = jsonb_build_object(
